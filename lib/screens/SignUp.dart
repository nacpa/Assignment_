              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:  EdgeInsets.only(left:D.Hight20),
                    child: CustomText("",
                        txt: "Please SignUp with Your Phone number to  get Register",
                        txtSize: D.Hight30 / 2,
                        clr: Colors.black87,
                        bold: false),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(onTap: (){
                        Get.to(SignIn(),transition: Transition.leftToRightWithFade);
                      },
                        child: CustomText("",
                            txt: "SignIn ", txtSize: D.Hight20, clr: g1, bold: true),
                      ),
                    ],
                  ),
                  SizedBox(
